...
function setServoAngle(){
	let valueRangeMin = document.getElementById('servo_angle').value;
	let valueRangeMax = document.getElementById('servo_angle').value;
...
function configureRegister() {
    ...
    const registerMinute = document.getElementById('register_minute').value;
    const registerDays = document.getElementById('register_days').value;

    const requestData = {
        number: registerNumber,
        hour: registerHour,
        minute: registerMinute,
        days: registerDays
    };
